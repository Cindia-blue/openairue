...
static const ProtobufCFieldDescriptor protocol__flex_cell_config__field_descriptors[39] =
{
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    offsetof(Protocol__FlexCellConfig, has_cell_id),
    offsetof(Protocol__FlexCellConfig, cell_id),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned protocol__flex_cell_config__field_indices_by_name[] = {
  ...
  33,   /* field[33] = dl_freq */
  36,   /* field[36] = dl_pdsch_power */
  14,   /* field[14] = duplex_mode */
  31,   /* field[31] = enable_64QAM */
  35,   /* field[35] = eutra_band */
  ...
  34,   /* field[34] = ul_freq */
  37,   /* field[37] = ul_pusch_power */
};
static const ProtobufCIntRange protocol__flex_cell_config__number_ranges[3 + 1] =
{
  { 1, 0 },
  { 13, 11 },
  { 42, 38 },
...
const ProtobufCMessageDescriptor protocol__flex_cell_config__descriptor =
{
  ...
  3,  protocol__flex_cell_config__number_ranges,
