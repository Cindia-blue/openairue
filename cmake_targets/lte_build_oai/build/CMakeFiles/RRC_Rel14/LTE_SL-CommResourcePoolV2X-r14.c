...
static asn_TYPE_member_t asn_MBR_LTE_rxParametersNCell_r14_49[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_SL_CommResourcePoolV2X_r14__rxParametersNCell_r14, syncConfigIndex_r14),
		...
		0,
		{ 0, &asn_PER_memb_LTE_syncConfigIndex_r14_constr_51,  memb_LTE_syncConfigIndex_r14_constraint_49 },
		0, 0, /* No default value */
		"syncConfigIndex-r14"
		},
};
...
asn_TYPE_member_t asn_MBR_LTE_SL_CommResourcePoolV2X_r14_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct LTE_SL_CommResourcePoolV2X_r14, zoneID_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LTE_zoneID_r14_constr_53,  memb_LTE_zoneID_r14_constraint_1 },
		0, 0, /* No default value */
		"zoneID-r14"
		},
	{ ATF_POINTER, 6, offsetof(struct LTE_SL_CommResourcePoolV2X_r14, threshS_RSSI_CBR_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LTE_threshS_RSSI_CBR_r14_constr_54,  memb_LTE_threshS_RSSI_CBR_r14_constraint_1 },
		0, 0, /* No default value */
