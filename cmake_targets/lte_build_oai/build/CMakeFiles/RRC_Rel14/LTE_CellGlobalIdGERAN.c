...
asn_TYPE_member_t asn_MBR_LTE_CellGlobalIdGERAN_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CellGlobalIdGERAN, locationAreaCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LTE_locationAreaCode_constr_3,  memb_LTE_locationAreaCode_constraint_1 },
		0, 0, /* No default value */
		"locationAreaCode"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_CellGlobalIdGERAN, cellIdentity),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LTE_cellIdentity_constr_4,  memb_LTE_cellIdentity_constraint_1 },
		0, 0, /* No default value */
		"cellIdentity"
		},
};
